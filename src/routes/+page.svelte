				...
				<div class="col-12">
					...
					<div class="hero__content">
						...
						<div class="hero__btns">
							<a href="aggregator" class="hero__btn"><span>Explore</span></a>
			...
			<div class="row">
				...
				<div class="col-12">
					<div class="section__title section__title--between">
						...
						<p>We take pride in collaborating with our partners who help us provide the best services to our clients. If you'd like to become our partner, please <br><a href="contacts/">contact us.</a></p>
					</div>
				</div>
				<!-- end section title -->
