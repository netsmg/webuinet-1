		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-lg-4">
					<div class="step step--first step--mt">
						<span class="step__number">01</span>
						<h3 class="step__title">Play to Earn & <br>Metaverse Aggregator</h3>
						<p class="step__text">Is a platform that brings together various metaverse worlds, providing access to different content and opportunities.</p>
					</div>
				</div>
				<!-- end step -->
				...
				<!-- step -->
				<div class="col-12 col-lg-4">
					<div class="step step--green step--mt">
						<span class="step__number">02</span>
						<h3 class="step__title">GameFi & <br>Web 3.0 Launchpad</h3>
						<p class="step__text">Incubator for projects aimed at developing decentralized applications, blockchain technologies and ecosystems.</p>
					</div>
				</div>
				<!-- end step -->	
				...
				<!-- step -->
				<div class="col-12 col-lg-4">
					<div class="step step--light step--mt">
						<span class="step__number">03</span>
						<h3 class="step__title">Rent NFT <br>Marketplace</h3>
						<p class="step__text">Renting and leasing digital assets, such as some cryptocurrency tokens, which are stored as non-exchangeable tokens (NFTs).</p>
					</div>
				</div>
				<!-- end step -->
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-xl-6 offset-xl-3">
					<div class="section__title">
						<h2>Our Team</h2>
						<p>Our team consists of professionals who combine their experience and knowledge in various fields to create quality and innovative projects. We strive for excellence in everything we do and are constantly looking for new ways to improve our products and services.</p>
					</div>
				</div>
				<!-- end section title -->
			</div>
	...
	<section class="section section--light">
		<div class="container">
			<div class="row">
				...
				<!-- carousel -->
				<div class="col-12">
					<div class="section__carousel section__carousel--block splide splide--block">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
					<div class="section__title">
						...
						<p>Our team of experts has created a detailed guide that covers everything from product features to use cases and market trends.</p>
					</div>
				</div>
				<!-- end section title -->
			</div>
			...
			<div class="row">
				<div class="col-12 col-md-6 col-lg-4">
					<div class="resources">
						...
						<h3 class="resources__title">Whitepaper</h3>
						<p class="resources__text">For those who want to get more information about our project, we put the Whitepaper in free access. Just download it at the link below.</p>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="resources resources--green">
						...
						<h3 class="resources__title">Litepaper</h3>
						<p class="resources__text">Learn more about our project by downloading our Litepaper. You'll find a detailed description of our strategy, goals and benefits.</p>
						<a href="/" class="resources__link">Download</a>
					</div>
				</div>
				...
				<div class="col-12 col-lg-4">
					<div class="resources resources--light">
						...
						<h3 class="resources__title">Pitch Deck</h3>
						<p class="resources__text">Whether you're a business owner, investor, or industry professional, our whitepaper is an essential resource for staying ahead of the competition.</p>
						<a href="/" class="resources__link">Download</a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-0 align-self-center">
					<div class="section__title section__title--grid-right">
						...
						<p>We strive for long-term cooperation with our partners, and our team is always ready to meet and consider new opportunities for mutual benefits. If you would like to become our partner, we are always open to new offers and look forward to hearing from you.</p>
						<p>If you are interested in working with us, please contact us and we will answer all your questions.</p>
						<a href="/" class="section__btn section__btn--grid"><span>Become</span></a>
					</div>
				</div>
				<!-- end section title -->
				...
				<div class="col-12 col-lg-6 align-self-center">
					<ul class="sponsors sponsors--small">
						<li>
							<a href="/">
	...
	<section class="section">
		<div class="container">
			<div class="row">
				...
				<!-- carousel -->
				<div class="col-12">
					<div class="section__carousel section__carousel--content splide splide--content">
						<div class="splide__arrows">
							<button class="splide__arrow splide__arrow--prev" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17,11H9.41l3.3-3.29a1,1,0,1,0-1.42-1.42l-5,5a1,1,0,0,0-.21.33,1,1,0,0,0,0,.76,1,1,0,0,0,.21.33l5,5a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42L9.41,13H17a1,1,0,0,0,0-2Z"></path></svg></button>
							<button class="splide__arrow splide__arrow--next" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17.92,11.62a1,1,0,0,0-.21-.33l-5-5a1,1,0,0,0-1.42,1.42L14.59,11H7a1,1,0,0,0,0,2h7.59l-3.3,3.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0l5-5a1,1,0,0,0,.21-.33A1,1,0,0,0,17.92,11.62Z"></path></svg></button>
						</div>
						...
						<div class="splide__track">
							<ul class="splide__list">
								<li class="splide__slide">
									<div class="testimonial">
										<div class="testimonial__text">
											<p>«Dmitry is an incredibly talented designer who consistently exceeds my expectations. His attention to detail and creativity are unmatched.»</p>
										</div>
								...
								<li class="splide__slide">
									<div class="testimonial">
										<div class="testimonial__text">
											<p>«His professionalism and ability to bring my vision to life were impressive.»</p>
										</div>
								...
								<li class="splide__slide">
									<div class="testimonial">
										<div class="testimonial__text">
											<p>«He has an eye for aesthetics that is unmatched and he always delivers high-quality work that exceeds expectations.»</p>
										</div>
								...
								<li class="splide__slide">
									<div class="testimonial">
										<div class="testimonial__text">
											<p>«He is always willing to go above and beyond to ensure that his clients are happy with the final product.»</p>
										</div>
								...
								<li class="splide__slide">
									<div class="testimonial">
										<div class="testimonial__text">
											<p>«I have had the pleasure of working with Dmitry on multiple design projects and he never fails to impress me.»</p>
										</div>
