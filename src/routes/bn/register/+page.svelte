...
async function register() {
    ...
    // Validate password
    if (!password.trim()) {
        errorMessage = 'পাসওয়ার্ড দাও';
    } else if (password.length < 6) {
        errorMessage = 'পাসওয়ার্ড অবশ্যই কমপক্ষে ছয় অক্ষরের হতে হবে';
    }
...
<!-- page wrap -->
	<div class="section section--content">
		<div class="section__content">
			<!-- form -->
			<form  class="form form--content" on:submit|preventDefault={register}>
...
<feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_76_4" result="shape"/>
					...
					<span class="form__tagline">WEBUInet এ আপনাকে স্বাগতম! </span>
...
{/if}
          ...
          <input type="email" id="email" bind:value={email} class="form__input" placeholder="ইমেইল">
				</div>

				<div class="form__group">
          <input type="password" id="password" bind:value={password} class="form__input" placeholder="পাসওয়ার্ড">
				</div>
				...
				<button class="form__btn" type="submit">রেজিস্টার করুন</button>
				...
				<span class="form__text form__text--center">অ্যাকাউন্ট আছে? <a href="/bn/login">লগিন করুন</a><br> <a href="/bn/forgot">পাসওয়ার্ড ভুলে গেছি?</a></span>
			</form>
			<!-- end form -->
		</div>
