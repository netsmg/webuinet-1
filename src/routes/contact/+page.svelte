			...
			<div class="row">
				...
				<div class="col-12 col-lg-5">
					...
					<div class="section__title section__title--left section__title--page">
						<h1>Get In Touch</h1>
						<p>We are always happy to help and provide more information about our services. You can contact us through email, phone, or by filling out the form on our website. <br>Thank you for considering us!</p>
					</div>
					<!-- end section title -->
					...
					<div class="contacts">
						<div class="contacts__list">
							...
							<a href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom" class="contact" target="_blank">
								<span class="contact__icon">
						...
						<div class="social">
							...
							<div class="social__list">
								...
								<a href="/">
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.20905,6.41669H22V4.08331H14.51978l-2.48584,9.16663h-.068L9.50269,4.08331H2V6.41663h.76837A.89578.89578,0,0,1,3.5,7.11139v9.83032a.84093.84093,0,0,1-.73163.6416H2v2.33338H8V17.58331H6.5V7.25h.08752L10.0451,19.91669h2.712L16.25989,7.25h.07355V17.58331H14.83337v2.33338H22V17.58331h-.79095a.83931.83931,0,0,1-.70905-.6416V7.11145A.8976.8976,0,0,1,21.20905,6.41669Z"/></svg>
								</a>
								<a href="/">
						...
						<div class="row">
							<div class="col-12 col-md-6">
								<div class="form__group">
									...
									<input id="name" bind:value={formData.name} type="text" name="name" class="form__input" placeholder="Full name">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form__group">
									<label for="mail" class="form__label">Email</label>
									<input id="email" bind:value={formData.email} type="text" name="mail" class="form__input" placeholder="example@domain.com">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form__group">
									<label for="phone" class="form__label">Phone</label>
									<input id="phone" bind:value={formData.phone} type="text" name="phone" class="form__input" placeholder="800 543 - 2109">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form__group">
									<label for="subject" class="form__label">Subject</label>
									<input id="subject" bind:value={formData.subject}  type="text" name="subject" class="form__input" placeholder="Ex. Support">
								</div>
							</div>
							<div class="col-12">
								<div class="form__group">
									<label for="message" class="form__label">Message</label>
									<textarea id="message" bind:value={formData.message} name="message" class="form__textarea" placeholder="Please enter your message..."></textarea>
								</div>
							</div>

							<div class="col-12">
								<button type="submit" class="form__btn form__btn--small">Submit</button>
							</div>
						</div>
					</form>
				</div>
